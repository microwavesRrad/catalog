...
// Leaflet calculates its canvas/tile dimensions when it initializes.
// Safari can occasionally keep stale dimensions after responsive CSS settles,
// so explicitly re-check the map whenever its container changes size.
...
if ("ResizeObserver" in window) {
  ...
  mapResizeObserver.observe(document.querySelector(".map-shell"));
}
